    ...
    <div className="shadow-2xl max-md:space-y-5 bg-white shadow-neutral-400 w-fit p-14 max-md:px-5 rounded-xl rounded-br-[200px] max-md:rounded-br-[125px]">
      <div className="flex max-md:justify-center justify-between gap-5 w-[500px] max-md:w-[85vw] text-[#716F6F] font-semibold text-xs max-md:text-md">
        <div className="space-y-1">
          ...
          <div>
            <input
              className="text-black border-2 border-[#DBDBDB] p-4  rounded-md w-full text-[32px] max-md:text-xl"
              type="text"
              placeholder="DD"
            />
          </div>
      ...
      <div className="flex relative items-center justify-end  max-md:justify-center w-[700px] h-32 max-md:h-16 max-md:w-[85vw]">
      ...
      <div className="text-8xl max-md:text-4xl italic space-y-4 max-md:space-y-3" id="bottom">
